...
module.exports = "  <div class=\"row my-4\">\n      <div class=\"col-lg-6\">\n        <img class=\"img-fluid rounded\" alt=\"\" src=\"./assets/brand/tsbuilding.jpeg\">\n      </div>\n      <!-- /.col-lg-8 -->\n      <div class=\"col-lg-6\">\n        <h1>Towing Solutions</h1>\n        <p>We are a modern repossession and property towing company based in Fort Worth Texas. We are committed to providing our clients with honest and reliable recovery and towing services.</p>\n        <p>We understand the regulations brought forth by the Consumer Financial Protection Bureau and we are fully compliant.</p>\n        <p>We look forward to establishing a working relationship and hope to hear from you soon.</p>\n      </div>\n      <!-- /.col-md-4 -->\n    </div>\n\n    <div class=\"row my-4\">\n        <div class=\"col-lg-6\">\n            <h6>Comercial/Residential</h6>\n            <p>Our goal is to assist you and your residents in maintaining an organized and safe property. We have a very close relationship with TDLR and only operate within the legal limits of this industry.</p>  \n        </div>\n        <!-- /.col-lg-8 -->\n        <div class=\"col-lg-6\">\n          <h6>Recovery/Repossession</h6>\n          <p>We offer a modern repossession services, capable of meeting the ever changing needs of most lending institutions.</p>\n          <p>We have a dependable staff of field agents, office personnel , an in house skip tracer, and storage lot manager, all dedicated to providing the results you want and need. </p>\n          <p>We always deal with your customers in a respectful and knowledgeable manner, working efficiently to recover your assets, while offering the most competitive pricing. </p>\n        </div>\n        <!-- /.col-md-4 -->\n    </div>"
...
module.exports = "  <div class=\"row my-4\">\n      <div class=\"col-lg-6\">\n        <img class=\"img-fluid rounded\" alt=\"\" src=\"../../assets/brand/tstruck.jpeg\">\n      </div>\n      <!-- /.col-lg-8 -->\n      <div class=\"col-lg-6\">\n        <h1>Features and Benefits</h1>\n        <p class=\"lead\">We own and operate our office and storage facility.</p>\n        <p>Our services include Comercial and Residential towing and the repossession of: Automobiles, Trucks, Trailers, Recreational Vehicles, Watercraft, Livestock.</p>\n        <p>Our office and 3 acre secure storage lot is protected by an 8 foot privacy fence, topped with 2 feet of barbed wire and razor wire with guardrail inside. Activity is monitored and recorded using audio and video surveillance and our building is staffed 24 hours a day, 7 days a week.</p>\n        <p>All of our tow trucks are equipped with audio and video cameras. Additionally, our drivers take photos of every vehicle before it is towed. This ensures violation confirmation and documents any existing vehicle damage.</p>\n      </div>\n      <!-- /.col-md-4 -->\n    </div>\n\n    <div class=\"row my-4\">\n        <div class=\"col-lg-6\">\n            <h4>Comercial/Residential Services:</h4>\n            <ul class=\"list-group list-group-flush\">\n              <li class=\"list-group-item\">Customized Patrol service to fit your community or business needs.</li>\n              <li class=\"list-group-item\">Daily and Nightly Patrols.</li>\n              <li class=\"list-group-item\">Video documentation for each tow.</li>\n              <li class=\"list-group-item\">Prompt email with pictures attached, time and Geo coordinates of ach tow.</li>\n              <li class=\"list-group-item\">Signs are provided by Towing Solutions and can be printed in English and Spanish.</li>\n              <li class=\"list-group-item\">Permits provided to both residents and visitors.</li>\n              <li class=\"list-group-item\">Illegal activity reported.</li>\n              <li class=\"list-group-item\">All fees paid by the vehicle owner.</li>\n            </ul>      \n          </div>\n        <!-- /.col-lg-8 -->\n        <div class=\"col-lg-6\">\n          <h4>Recovery Services:</h4>\n          <ul class=\"list-group list-group-flush\">\n            <li class=\"list-group-item\">After hours and weekend monitoring of phones, email, RDN, etc.</li>\n            <li class=\"list-group-item\">A full time, in house skip tracer, to help locate your debtor and collateral.</li>\n            <li class=\"list-group-item\">We will release your collateral to an auto auction or we can transport it to a local auction for a minimal fee.</li>\n            <li class=\"list-group-item\">We have a trained locksmith who can make almost any key, even the newest laser cuts and transponders.</li>\n            <li class=\"list-group-item\">We can front most fees on your behalf, at no additional cost should your collateral be impounded.</li>\n            <li class=\"list-group-item\">We have a close relationship to local, reputable wholesale car buyers, if you need us to take bids on your collateral.</li>\n            <li class=\"list-group-item\">We have a 1 million dollar bond and carry 3 million dollars in liability insurance, which includes wrongful repossession by an “A” rated company.</li>\n            <li class=\"list-group-item\">Our entire staff is covered under a workman’s compensation insurance plan as well.</li>\n          </ul>      \n        </div>\n        <!-- /.col-md-4 -->\n      </div>\n"
